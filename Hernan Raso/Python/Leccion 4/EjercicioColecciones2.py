...
# Escriba un programa que tenga 2 listas y que a continuacion cree las siguientes
# listas (en las que no deben haber repeticion).
...
print(f"Lista de palabras que coinsiden en ambas listas: {interseccion}")
