...
#escriba un programa que tenga 2 listas y que a continuacion cree las siguientes listas (en las que no debe haber repeticion)
...
solo1 = list((conjunto1 - conjunto2)) #solo muestra conjunto 1
solo2 = list((conjunto2 - conjunto1)) #solo muestra conjunto 2
