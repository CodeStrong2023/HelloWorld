...
//        }
        ...
        personas[0][0] = new Persona("Flor");
        personas[0][1] = new Persona("Regi");
        personas[0][2] = new Persona("Rufi");
        personas[1][0] = new Persona("Vero");
        personas[1][1] = new Persona("Nere");
        personas[1][2] = new Persona("Pauli");
